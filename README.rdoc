...
* <tt>Foo.advance_version(&block)</tt> : run +block to create a new version of the table. the working table will appear
active to the +Thread running +block , and if +block completes then the working table will become permanently globally active
